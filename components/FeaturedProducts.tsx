...
//   const { isFavorited, addToFavorites, removeFromFavorites, mounted } =
//     useFavorites();
...
//               key={product.id}
//               className="group overflow-hidden border-border hover:shadow-lg transition-all duration-300 relative"
//             >
